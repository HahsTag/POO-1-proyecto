    ...
    **DataFrame Pandas:**
        **.T =>** Convierte los diccionarios (Listas) en tablas visuales legibles para las filas ordenadas en vertical.  
        
    ---

    **datetime**
        **datetime.strptime()** Transforma una str en un formato de fecha y horas.
    ---
